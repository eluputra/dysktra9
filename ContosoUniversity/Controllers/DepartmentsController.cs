...
//created administrator drop down list 
// change all occurances of first mid to all full name
...
// it changes all the firstmid to display fullname
namespace ContosoUniversity.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        // POST: Departments/Delete/5
        // replacing deleteconfirmed
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Delete(Department department)//changed this parameter to a Department entity instance created by the model binder
        {
            try
            {
